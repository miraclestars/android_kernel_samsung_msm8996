...
static void adaptivex_early_suspend(struct power_suspend *handler) {
	adaptivex_suspend(1);
}

static void adaptivex_late_resume(struct power_suspend *handler) {
	adaptivex_suspend(0);
}

static struct power_suspend adaptivex_power_suspend = {
				   ...
				   unsigned int event)
{
	...
	case CPUFREQ_GOV_START:
		...
		register_power_suspend(&adaptivex_power_suspend);
	...
	case CPUFREQ_GOV_STOP:
		...
		pm_idle = pm_idle_old;
		unregister_power_suspend(&adaptivex_power_suspend);
		break;
