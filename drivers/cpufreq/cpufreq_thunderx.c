...
static void thunderx_early_suspend(struct power_suspend *handler) {
	int i;
...
static void thunderx_late_resume(struct power_suspend *handler) {
	int i;
...
static struct power_suspend thunderx_power_suspend = {
...
static int __init cpufreq_thunderx_init(void)
{
	...
	register_power_suspend(&thunderx_power_suspend);
